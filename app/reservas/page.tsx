      ...
      <section className="relative h-[30vh] sm:h-[35vh] bg-dark flex items-center justify-center">
        <div className="text-center px-4">
          ...
          <p className="mt-3 text-white/70 text-lg">
            Solicita tu reserva y vive la experiencia amazónica
          </p>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2 order-1 lg:order-2">
              {/* Logo placeholder */}
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 mb-6 text-center">
                <div className="w-20 h-20 rounded-full bg-dark border-2 border-orange flex items-center justify-center mx-auto mb-4">
                  <span className="text-orange font-heading font-bold text-xl">ECO</span>
                </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <div className="flex flex-wrap gap-3 justify-center">
                  {[1, 2, 3].map((i) => (
                    ...
                    >
                      <span className="text-xs text-gray-text/50">#{i}</span>
                    </div>
                  ))}
                </div>
              </div>
